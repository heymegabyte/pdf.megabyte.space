...
const SOCIALS: Social[] = [
  {
    name: "GitHub",
    url: "https://github.com/megabyte-labs",
    hex: "#FFFFFF",
    path:
  ...
  {
    name: "GitLab",
    url: "https://gitlab.com/megabyte-labs",
    hex: "#FC6D26",
    path:
...
export function Footer() {
  return (
    <footer className="border-t border-[var(--color-line)] bg-[var(--color-bg)] mt-auto">
        ...
        <div className="grid sm:grid-cols-[1.4fr_1fr_1fr_1fr] gap-8">
          <div>
            <Link to="/" aria-label="Megabyte PDF home" className="inline-flex items-center gap-2 mb-3">
              <Logo size={28} />
              <span className="font-semibold tracking-tight">Megabyte PDF</span>
            </Link>
          ...
          <FooterColumn
            ...
            links={[
              ...
              { href: "https://github.com/megabyte-labs", label: "Open source", external: true },
            ]}
          />
          <FooterColumn
            title="Legal"
